...
/**
 * _myenviro - prints the current environment
...
/**
 * _getenviro - gets the value of an environ variable
 * @info: Structure containing potential arguments. Used to maintain
 * @name: env var name
 *
 * Return: the value
...
/**
 * _mysetenviro - Initialize a new environment variable,
...
int _myunsetenviro(info_t *info)
{
	...
	for (i = 1; i <= info->argc; i++)
		_unsetenviro(info, info->argv[i]);

	return (0);
}

/**
 * pop_enviro_list - populates env linked list
 * @info: Structure containing potential arguments. Used to maintain
 *          constant function prototype.
 * Return: Always 0
 */
